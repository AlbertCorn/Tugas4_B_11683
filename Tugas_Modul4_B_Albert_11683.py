...
st.set_page_config(
    page_title="11683 - Unsupervised Learning", 
    page_icon= "",
    layout="wide",
...
if uploaded_file is not None:
    ...
    st.markdown("<h1 style='text-align: centerl'>Unsupervised Learning - 11683</h1>", unsafe_allow_html=True)
    st.dataframe(input_data)
    
    model_directory = r'D:\Semester 5\Pembelajaran mesin dan Pembelajaran Mendalam\MOdul unsupervised\Tugas4_B_11683'
    model_path = {
